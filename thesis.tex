...
While the proposed clinically-validated model for patients in the intensive care unit has shown to capture long-term insulin-glucose dynamics, in practice, typically it is only possible for clinicians to take blood glucose measurements, consequently, excluding measurements for the dynamics seen in Equations \eqref{eq:Q} to \eqref{eq:P2}. Thus, leveraging estimators is a viable solution to account for the lack of intuition into the dynamics that can not be measured.
...
\section{Patient Identifiability}
\subsection{Observability}
\subsection{Integral-Based Fitting}
