...
\authorsLastname{Mulvihill}
\authorsFirstname{Markus}
\email{mulv\@kth.se}
\kthid{u100001}
...
\supervisorAsLastname{Lindström}
\supervisorAsFirstname{Martin}
\supervisorAsEmail{martin12@kth.se}
% If the supervisor is from within KTH add their KTHID, School and Department info
\supervisorAsKTHID{u15dflcv}
\supervisorAsSchool{\schoolAcronym{EECS}}
\supervisorAsDepartment{Teknisk informationsvetenskap}
...
\examinersLastname{Thobaben}
\examinersFirstname{Ragnar}
\examinersEmail{ragnart@kth.se}
% If the examiner is from within KTH add their KTHID, School and Department info
\examinersKTHID{u1rs7mp9}
\examinersSchool{\schoolAcronym{EECS}}
\examinersDepartment{Teknisk informationsvetenskap}
